...
% NOTE that 85% is not true. The figure is 75% for AATAAA + ATTAAA
% In your summary output with the tail and everythig you need to specify the
% good pas. Tian found 70% of the two, and bauding 75 %.
% TODO this T PAS ratio things for all, to estimate the 'degree' (not number)
% of genuine non-PAS related polyadenylation
